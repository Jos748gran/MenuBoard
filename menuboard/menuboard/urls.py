...
urlpatterns = [
    ...
    path('item_pedido_list/', util_views.item_pedido_list, name="item_pedido_list"),
    ...
    path('crear_item_pedido_user/<int:id>/', pedidos_views.crear_item_pedido_user, name='crear_item_pedido_user'),
    ...
    path('ordenar_pedido/', pedidos_views.ordenar_pedido, name='ordenar_pedido'),
